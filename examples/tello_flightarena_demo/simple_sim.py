...
# case_name = '1v1b'
# file_name = 'tcTest_2d_PGtest.json'
file_name = 'test8x20_5d_ts.json'
# file_name = 'test5x5rows_1d_r.json'
case_name = 'scenebuilder' # One Vehicle and One building

case = Cases.get_case(file_name, case_name, tether_mode=1,mazeHeight=[-10,10])
...
LIMS = (-10,10)
trajectory_plot.ax.set_xlim((-4,4))
